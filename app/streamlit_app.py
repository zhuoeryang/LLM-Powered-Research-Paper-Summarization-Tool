...
def display_pdf(uploaded_file):
    ...
    The PDF will be displayed in an iframe
    """
    # Read file as bytes:
...
def load_streamlit_page():
    ...
    The left column contains a text input box for the user to input their OpenAI API key, and a file uploader for the user to upload a PDF document. 
    ...
    st.markdown("<h1 style='text-align: center; color: white;'>LLM-Powered Research Paper Summarization Tool</h1>", unsafe_allow_html=True)
    ...
    if st.button("Generate table"):
        with st.spinner("Generating answer"):
            ...
            answer = query_document(vectorstore = st.session_state.vector_store, 
                                    query = "Give me the paper summary, model motivation, model architecture, and model limitation of the research paper.",
                                    api_key = st.session_state.api_key)
